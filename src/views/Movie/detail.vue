...
export default {
  ...
  mounted() {
    //根据id来获取到不同的详情页数据
    var movieId = this.$router.history.current.params.movieId;
    setTimeout(() => {
      this.isLoading = false;
      var data = require("/public/data/detail/" + movieId + ".json");
      this.detailMovie = data.data.movie;
      console.log(this.$refs.detail_player);
      this.$nextTick(() => {
